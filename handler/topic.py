...
class IndexHandler(BaseHandler):
    def get(self, template_variables = {}):
        ...
        notice_text = "同学，暂时还没有话题，发出您的讨论吧。"
        if (tab == "college"):
            notice_text = "同学，你学校下暂时还没有话题，发出您的讨论吧。"
        if (tab == "interest"):
            notice_text = "同学，这里列出了您所关注小组下的最新话题，暂时还没有话题，发出您的讨论吧。"
        if (tab == "follows"):
            notice_text = "同学，这里列出了您所关注同学的最新话题，暂时还没有话题，发出你的讨论吧。"
...
class CreateHandler(BaseHandler):
    ...
    def get(self, college_node = None, template_variables = {}):
        user_info = self.current_user
        if (user_info["collegename"]=="同学，请设置您的学校哦"):
